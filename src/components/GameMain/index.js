...
import { getLeftPosition, getRightPosition, getRightWeight,getLeftWeight } from "../../ReduxStore/action";
...
const GameMain = () => {
    ...
    return (
        <div className="container">
            <TopController win={win} startGame={startGame} name={start ? 'Stop' : 'Start'} rightWeight={rightWeight} leftWeight={leftWeight} leftDistance={leftObjDistance} rightDistance={rightObjDistance}/>
